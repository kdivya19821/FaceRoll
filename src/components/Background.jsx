...
const Background = () => {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[60%] h-[60%] rounded-full bg-indigo-950/20 blur-[100px] animate-mesh"></div>
      
      {/* Mesh Gradient Layer 2 */}
      <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] rounded-full bg-violet-950/20 blur-[100px] animate-mesh" style={{ animationDelay: '-5s' }}></div>
      ...
      {/* Noise Texture Overlay (optional, for that high-end grain) */}
